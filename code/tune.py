...
def search_model(trial: optuna.trial.Trial) -> Tuple[List, Dict]:
    ...
    ACTIVATION_FUNCTION_LIST = ["ReLU", "Hardswish", "HardTanh", "ReLU6", "ELU", "SELU", "CELU", "LeakyReLU"]
    CONV_BLOCK_LIST = ["Conv", "DWConv", "InvertedResidualv2", "InvertedResidualv3", "Pass", "MBConv", "Bottleneck"]
    ...
    if m1_stride == 2:
        n_stride += 1
    m1_activation = trial.suggest_categorical("m1/activation", ACTIVATION_FUNCTION_LIST)
    if m1 == "Conv":
    ...
    if m2 == "Conv":
        ...
        m2_activation = trial.suggest_categorical(
            "m2/activation", ACTIVATION_FUNCTION_LIST
        )
    ...
    if m3 == "Conv":
        ...
        m3_activation = trial.suggest_categorical(
            "m3/activation", ACTIVATION_FUNCTION_LIST
        )
    ...
    if m4 == "Conv":
        ...
        m4_activation = trial.suggest_categorical(
            "m4/activation",ACTIVATION_FUNCTION_LIST
        )
    ...
    if m5 == "Conv":
        ...
        m5_activation = trial.suggest_categorical(
            "m5/activation", ACTIVATION_FUNCTION_LIST
        )
    ...
    if m6 == "Conv":
        ...
        m6_activation = trial.suggest_categorical(
            "m6/activation", ACTIVATION_FUNCTION_LIST
        )
    ...
    if m7 == "Conv":
        ...
        m7_activation = trial.suggest_categorical(
            "m7/activation", ACTIVATION_FUNCTION_LIST
        )
